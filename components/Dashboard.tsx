                        ...
                        {activeTab === 'profile' && (
                            <div className="max-w-2xl space-y-8 animate-in slide-in-from-bottom-4 duration-500">
                                ...
                                <div className="bg-brand-purple/5 border border-brand-purple/10 p-8 rounded-[2rem] relative overflow-hidden group">
                                    ...
                                    <h3 className="text-xl font-bold text-brand-text mb-2 font-outfit">Sua Jornada Estelar</h3>
                            ...
                            <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-500">
                                ...
                                <div className="bg-white/5 border border-white/10 rounded-3xl overflow-hidden">
                                    <div className="p-4 border-b border-white/5 bg-white/5">
                                        <h3 className="text-sm font-bold text-brand-text uppercase tracking-wider font-outfit">Gestão de Usuários</h3>
                                    </div>
